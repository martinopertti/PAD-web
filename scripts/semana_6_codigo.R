...
## ***************************************************************************
##  Semana 6: Introducción y fundamentos de la programación en R   
...
## * 2.1. Ejemplo del uso de una función: mean() ----
...
## * 2.2. Documentación de una función ----
help(mean)
?mean


## * 2.3. Funciones y códigos ----
...
## * 3.2. Utilzar función sin cargar paquete ----
